...
const allQuestions = [
    {
        question: "What is the Arabic name for the festival celebrated at the end of Ramadan?",
      ...
      {
        question: "Which sweet dish is commonly prepared in South Asian households for Eid?",
      ...
      },
      {
        ...
        options: ["Fasting", "Eating something sweet", "Giving Zakat", "Staying awake all night"],
      ...
      },
      {
        ...
        options: ["Alhamdulillah", "Eid Mubarak", "Allahu Akbar", "Dua for new moon"],
      ...
      },
      {
        ...
        options: ["Stay at the mosque", "Listen to the Eid khutbah", "Immediately eat", "Perform another prayer"],
      ...
      },
      {
        ...
        options: ["Give a handshake", "Give a hug", "Say 'Eid Mubarak'", "All of the above"],
        answer: "All of the above",
      },
      {
        question: "How do Muslims typically start their day on Eid?",
        options: ["By fasting", "By eating dates", "By going to work", "By visiting graves"],
        answer: "By eating dates",
      },
      {
        question: "What is a common Eid tradition in Turkey?",
        options: ["Exchanging gifts", "Visiting cemeteries", "Eating baklava", "All of the above"],
        answer: "All of the above",
      }
];
